...
import lk.sliit.parkingsystem.parkingsystem.model.Feedback;
import lk.sliit.parkingsystem.parkingsystem.model.SupportTicket;
import java.io.*;
...
public class FeedbackDAO {
    private static final String FILE_PATH = "C:\\Users\\senal\\Downloads\\VehicleParkingManagemenghtishu\\VehicleParkingManagement\\src\\main\\resources\\data\\feedback.txt";

    static {
        try {
            Files.createDirectories(Paths.get("C:\\Users\\senal\\Downloads\\VehicleParkingManagemenghtishu\\VehicleParkingManagement\\src\\main\\resources\\data"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
